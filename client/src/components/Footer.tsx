      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-semibold text-blue-900">BlueCBT</span>
            </div>
            <p className="text-gray-600 max-w-md">
              A modern computer-based testing platform designed to create, manage, and take tests with ease.
            </p>
          </div>
          
          <div>
            <h3 className="font-medium text-blue-900 mb-4">Platform</h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/tests" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Available Tests
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="font-medium text-blue-900 mb-4">Support</h3>
            <ul className="space-y-3">
              <li>
        ...
        <div className="border-t border-blue-100 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {currentYear} BlueCBT. All rights reserved.
          </p>
